...
| 3e v0.1 amendments (R6 cross-namespace lookup, R10 name-level schemas, R11 `reinstate`) | 🔵 in flight — launched 06:10; #4's Q12 (created_by gains `derived`) and Q13-Q21 are ruled separately (R17+), not folded into this row |
