"""Suite bookkeeping -- not one of the 129.

PACKAGE.md 6.2 enumerates 129 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 129 -- both because the suite is
