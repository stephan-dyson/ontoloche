"""Suite bookkeeping -- not one of the 127.

PACKAGE.md 6.2 enumerates 127 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 127 -- both because the suite is
