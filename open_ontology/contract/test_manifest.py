"""Suite bookkeeping -- not one of the 119.

PACKAGE.md 6.2 enumerates 119 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 119 -- both because the suite is
