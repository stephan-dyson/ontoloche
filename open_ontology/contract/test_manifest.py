"""Suite bookkeeping -- not one of the 128.

PACKAGE.md 6.2 enumerates 128 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 128 -- both because the suite is
