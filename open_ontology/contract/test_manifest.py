"""Suite bookkeeping -- not one of the 130.

PACKAGE.md 6.2 enumerates 130 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 130 -- both because the suite is
