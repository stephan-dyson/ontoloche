"""Suite bookkeeping -- not one of the 118.

PACKAGE.md 6.2 enumerates 118 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 118 -- both because the suite is
