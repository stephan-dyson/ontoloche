"""Suite bookkeeping -- not one of the 115.

PACKAGE.md 6.2 enumerates 115 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 115 -- both because the suite is
