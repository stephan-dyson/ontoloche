"""Suite bookkeeping -- not one of the 117.

PACKAGE.md 6.2 enumerates 117 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 117 -- both because the suite is
