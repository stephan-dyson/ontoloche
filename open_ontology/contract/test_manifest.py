"""Suite bookkeeping -- not one of the 137.

PACKAGE.md 6.2 enumerates 137 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 137 -- both because the suite is
