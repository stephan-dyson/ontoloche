"""Suite bookkeeping -- not one of the 132.

PACKAGE.md 6.2 enumerates 132 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 132 -- both because the suite is
