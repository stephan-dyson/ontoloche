"""Suite bookkeeping -- not one of the 140.

PACKAGE.md 6.2 enumerates 140 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 140 -- both because the suite is
