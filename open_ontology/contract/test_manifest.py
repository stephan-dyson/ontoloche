"""Suite bookkeeping -- not one of the 124.

PACKAGE.md 6.2 enumerates 124 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 124 -- both because the suite is
