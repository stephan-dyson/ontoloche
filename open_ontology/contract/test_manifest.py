"""Suite bookkeeping -- not one of the 113.

PACKAGE.md 6.2 enumerates 113 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 113 -- both because the suite is
