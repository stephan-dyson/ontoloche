"""Suite bookkeeping -- not one of the 121.

PACKAGE.md 6.2 enumerates 121 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 121 -- both because the suite is
