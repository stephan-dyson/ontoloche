"""Suite bookkeeping -- not one of the 135.

PACKAGE.md 6.2 enumerates 135 contract tests in seventeen groups and calls the
...
The number of collected pytest items is larger than 135 -- both because the suite is
