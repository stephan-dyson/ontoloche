# ---------------------------------------------------------------------------------
# GENERATED FILE -- do not edit. Edit open_ontology/contract/test_c13_cms.py and run:
#
...
from open_ontology.types import Proposal, TypeEntry
from open_ontology.aio.contract._support import FIXTURE, SEVERITY_ORDERING, load_cms_sample, sample_facts
