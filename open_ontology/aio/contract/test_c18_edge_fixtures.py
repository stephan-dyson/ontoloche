# ---------------------------------------------------------------------------------
# GENERATED FILE -- do not edit. Edit open_ontology/contract/test_c18_edge_fixtures.py and run:
#
...
pre-registered numbers, driven through `open_ontology.AsyncRegistry` and a real backend on
...
from open_ontology.edges import EQUIVALENT_TO, InstanceRef, TypeRef
from open_ontology.types import Evidence, Refusal
from open_ontology.aio.contract._support import cms_edges, edge_family, load_cms_sample, nyc_edge_sample, seed
...
async def test_c18_04_a_value_set_is_not_an_instance_endpoint_and_the_class_stays_out(registry):
    ...
    **yes, they all fit**, and therefore the whole class is refused.
    ...
    from open_ontology.aio.contract._support import read_sample
