# ---------------------------------------------------------------------------------
# GENERATED FILE -- do not edit. Edit open_ontology/contract/test_c5_approve_reject.py and run:
#
...
from open_ontology.types import Evidence, Proposal, Refusal, Rejection, TypeEntry
