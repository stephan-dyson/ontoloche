...
from open_ontology.contract.test_manifest import EXPECTED_PER_GROUP, TOTAL
from open_ontology.contract.test_manifest import implemented_ids as sync_implemented_ids
