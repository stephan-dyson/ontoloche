...
--
-- Timestamps are TEXT, ISO-8601, UTC, Z-suffixed -- the same format the rest of this
-- schema uses, chosen because it sorts correctly as text. The invocation cursor is a
-- keyset on (created_at, invocation_id), so that property is what makes
-- `find_invocations` pageable.
