# ---------------------------------------------------------------------------------
# GENERATED FILE -- do not edit. Edit ontoloche/contract/test_c1_consumers.py and run:
#
...
import pytest
from ontoloche.errors import UnknownType
from ontoloche.types import Consumer, Refusal
