...
``ontoloche/contract/test_c0_concurrency.py``; both claim contract id **C0-08**.
...
from ontoloche.adapter import TypeQuery, TypeRecord
from ontoloche.errors import (
    AlreadyExists,
    HostTransactionRequired,
    SavepointOutOfOrder,
    SchemaMismatch,
)
from ontoloche.types import Refusal, TypeEntry

from . import _support
from ontoloche.contract._coverage import BORROWED_CAPS
