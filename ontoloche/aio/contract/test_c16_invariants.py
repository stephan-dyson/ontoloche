# ---------------------------------------------------------------------------------
# GENERATED FILE -- do not edit. Edit ontoloche/contract/test_c16_invariants.py and run:
#
...
async def test_c16_06_no_two_active_entries_in_one_namespace_hold_one_word(exercised, adapter):
