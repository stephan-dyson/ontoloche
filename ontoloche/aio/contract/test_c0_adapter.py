# ---------------------------------------------------------------------------------
# GENERATED FILE -- do not edit. Edit ontoloche/contract/test_c0_adapter.py and run:
#
...
import pytest
from ontoloche import adapter as adapter_module
...
from ontoloche.errors import AlreadyExists, AmbiguousKind, NotSupported
from ontoloche.aio.contract._support import snapshot
...
FORBIDDEN = (
    ...
    # list -- live in `ontoloche/actions.py`, and an adapter that knew about
...
async def test_c0_06_every_record_round_trips_and_a_gap_comes_back_empty(adapter):
    ...
    **The `requires_capability("stores_proposals")` marker is gone**, and that is part
    ...
    dcaps = await degraded.capabilities()
