...
**Implemented 2026-08-28, row 3c.** INTERFACE §5.12 now enumerates fifteen; `Registry.register_consumer` returns `Consumer | Refusal`; `C11-04` asserts `reason == "consumer_source_read_only"` in the sync suite and, by generation, in the async one. Suites green: `229 passed` sync, `267 passed` async. Deviation D-1 is marked resolved in [`../runs/2A-RUN.md`](../runs/2A-RUN.md) §4.1 and [`../runs/3B-ASYNC.md`](../runs/3B-ASYNC.md) §5.
