...
**C4 — `propose_type` (15).** Mechanism **1**.
...
**C5 — `approve` / `reject` (13).** Mechanism **1**.
...
**C9 — `retire` and `reinstate` (35).** Mechanism **3**.
...
**C10 — `merge_types`, and the doors its operands come through (20).** Mechanism **4**.
...
**C12 — Foundry import mapping, and the fourth door into the kill row (21).** From 0.3 consequence 2 / `INTERFACE.md` §2.5.
