...
**C17 — edges: the store and the read seam (43).** `EDGES.md` v0, row 4b; **C17-35 … C17-40** by row 4c (ruling **R34**) and **C17-41 … C17-43** by the same row (ruling **R37**). Mechanisms **C** (dominant, and [Observed] rather than assumed) and **4**.
