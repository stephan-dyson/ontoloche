...
**C9 — `retire` and `reinstate` (34).** Mechanism **3**.
...
**C12 — Foundry import mapping, and the fourth door into the kill row (19).** From 0.3 consequence 2 / `INTERFACE.md` §2.5.
