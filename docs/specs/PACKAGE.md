...
**C4 — `propose_type` (12).** Mechanism **1**.
...
**C10 — `merge_types`, and the doors its operands come through (16).** Mechanism **4**.
...
**C12 — Foundry import mapping, and the fourth door into the kill row (12).** From 0.3 consequence 2 / `INTERFACE.md` §2.5.
