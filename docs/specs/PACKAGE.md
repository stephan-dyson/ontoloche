...
**C10 — `merge_types`, and the doors its operands come through (26).** Mechanism **4**.
...
**C12 — Foundry import mapping, and the fourth door into the kill row (26).** From 0.3 consequence 2 / `INTERFACE.md` §2.5.
