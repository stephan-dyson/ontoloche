...
**C17 — edges: the store and the read seam (29).** `EDGES.md` v0, row 4b. Mechanisms **C** (dominant, and [Observed] rather than assumed) and **4**.
