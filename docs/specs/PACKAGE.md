...
**C3 — `resolve_type` (15).** Mechanisms **2**, and **1** as the gate.
...
**C4 — `propose_type` (13).** Mechanism **1**.
...
**C10 — `merge_types`, and the doors its operands come through (18).** Mechanism **4**.
