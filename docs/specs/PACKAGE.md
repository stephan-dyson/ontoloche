...
**C17 — edges: the store and the read seam (46).** `EDGES.md` v0, row 4b; **C17-35 … C17-40** by row 4c (ruling **R34**), **C17-41 … C17-43** by the same row (ruling **R37**), and **C17-44 … C17-46** by the same row (ruling **R38**, which also rewrote `C17-33`). Mechanisms **C** (dominant, and [Observed] rather than assumed) and **4**.
