...
**C3 — `resolve_type` (14).** Mechanisms **2**, and **1** as the gate.
...
**C4 — `propose_type` (11).** Mechanism **1**.
...
**C10 — `merge_types`, and the doors its operands come through (14).** Mechanism **4**.
...
**C12 — Foundry import mapping, and the fourth door into the kill row (11).** From 0.3 consequence 2 / `INTERFACE.md` §2.5.
