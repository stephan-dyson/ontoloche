...
**21. `find_invocations(*, family: str | None = None, namespace: str | None = None, actor: str | None = None, outcome: str | None = None, since: datetime | None = None, gate_verdict: str | None = None, effect_undeclared: bool | None = None, unreviewed: bool | None = None, after: str | None = None, limit: int = 100) -> InvocationPage`**
...
**C12 — Foundry import mapping, and the fourth door into the kill row (13).** From 0.3 consequence 2 / `INTERFACE.md` §2.5.
...
| C19-54 | **§10-9** a host whose families all declare `reachability=()` gets zeroes rather than a typo refusal, and a `namespace` that holds no such family is a legitimate scope — **[Observed, round 2]** the rule misfiring on the venture's own customer | **C** |
