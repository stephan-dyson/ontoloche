...
**C10 — `merge_types`, and the door its operands come through (12).** Mechanism **4**.
...
**C12 — Foundry import mapping, and the fourth door into the kill row (10).** From 0.3 consequence 2 / `INTERFACE.md` §2.5.
...
**C17 — edges: the store and the read seam (50).** `EDGES.md` v0, row 4b; **C17-35 … C17-40** by row 4c (ruling **R34**), **C17-41 … C17-43** by the same row (ruling **R37**), **C17-44 … C17-46** by the same row (ruling **R38**, which also rewrote `C17-33`), **C17-47** (ruling **R39**), and **C17-48 … C17-50** by that row's FIRST adversarial round. Mechanisms **C** (dominant, and [Observed] rather than assumed) and **4**.
