...
### 5.12 `Refusal.reason` is a closed vocabulary *(added by ruling R3, 2026-08-28; fifteenth value added by ruling R4, row 3c, 2026-08-28; four EDGES values added by row #4, 2026-08-29; **twentieth and twenty-first** added by ruling R11, row 3e, 2026-08-29)*
