...
| 2 | Reinstating would leave **two active entries with one word between them**, down an alias or a chain of successions | **`alias_collision`** | **No** |
